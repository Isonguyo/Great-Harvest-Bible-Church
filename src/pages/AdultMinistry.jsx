...
const AdultMinistry = () => {
  ...
  // Generate images in ascending order
  const images = Array.from(
    { length: 120 },
    (_, i) => `images/ghbc${i + 1}.jpg`
  );

  // 🔄 Reverse globally so newest (ghbc120) comes first
    ...
    <section className="adults-page">
      ...
      <div className="adults-container">
        ...
        <div className="adults-about section">
          ...
          <p>
            Our Adults Ministry provides a space for spiritual growth,
            fellowship, and service. We aim to nurture and strengthen your walk
            with God through prayer, Bible study, and impactful programs that
        ...
        <div className="section">
          ...
          <p>
            Join us every Sunday at <strong>9:00 AM</strong> and during our
            mid-week Bible study on <strong>Wednesdays at 6:00 PM</strong>.
          </p>
        </div>
