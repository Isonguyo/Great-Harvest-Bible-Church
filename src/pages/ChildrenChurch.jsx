...
const ChildrenChurch = () => {
  ...
  // Generate image paths in ascending order
  const images = Array.from({ length: 54 }, (_, i) => `images/child${i + 1}.jpg`);

  // 🔄 Reverse globally so newest (child54.jpg) comes first
    ...
    <section className="children-church">
      ...
      <div className="children-container">
        ...
        <div className="children-about fade-in">
          ...
          <p>
            Our Children’s Church provides a safe, loving, and fun environment
            where kids learn about Jesus in ways they can understand. We believe
            in equipping the next generation with biblical principles through
...
export default ChildrenChurch;                        <img src={lightboxImage} alt="Preview" className="lightbox-img" />
